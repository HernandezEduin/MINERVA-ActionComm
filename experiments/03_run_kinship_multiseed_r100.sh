...
# MINERVA-ActionComm
# Stage 3A: Kinship R=100, five execution seeds
...
#   numpy_policy
#
# Execution seeds: 42, 43, 44, 45, 46
#
# Run from the repository root:
#   bash 03_run_kinship_multiseed_r100.sh

echo "=== Stage 3A: Kinship R=100 execution-seed sweep ==="

for s in 42 43 44 45 46; do
  echo
  echo ">>> Kinship | R=100 | execution seed=${s}"
